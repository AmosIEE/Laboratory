  ...
  initWebAssembly = () => {
    ...
    const Module = {
      ...
      preRun: [function() {
        ...
        Module.FS_createPreloadedFile('/', 'haarcascade_frontalface_default.xml', 'https://raw.githubusercontent.com/opencv/opencv/master/data/haarcascades/haarcascade_frontalface_alt2.xml', true, false)
